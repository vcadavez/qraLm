ca_Washing_ui <- function(id) {
  ...
  fluidRow(
    column(6, 
           h4("Prevalence of contaminated lots"), prevLotsUI("prev_lots_washing"),
           h4("Between lots LM counts"), mcstatsLotsUI("lots_mcstats_washing")
           #           h4("Between lots LM counts distribution"), countsLotsDistUI("counts_lots_dist_washing")
    ),
    column(6, 
           h4("Prevalence of contaminated units"), prevUnitsUI("prev_units_washing"),
           h4("Within lots/Between units LM counts"), mcstatsUnitsUI("units_mcstats_washing")
           #           h4("Within lots/Between units distribution"), countsUnitsDistUI("counts_units_dist_washing")
    ),
    column(12, 
           h4("Empirical Cumulative Distribution Function (ECDF)"), ecdfLotsUI("ecdf_prob_washing")
    )
  )
}
