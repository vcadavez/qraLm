...
#' nLots <- 1000
#' sizeLot <- 100
#' # df <- list(N = matrix(rpois(sizeLot*nLots, 2), ncol=sizeLot, nrow=nLots), P = .16)
#' # CantaDices <- caDicing (df, cantaSurface=780,cantaRindFree=1050,
#' # nLots=nLots, sizeLot=sizeLot,sizeSublot=25)
#' # hist(CantaDices$N)
#'
